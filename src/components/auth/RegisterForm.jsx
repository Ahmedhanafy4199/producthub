...
const RegisterForm = () => {
  ...
  const Field = ({ id, label, name, type = 'text', placeholder, children }) => (
    <div>
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-slate-300 mt-1">Join ProductHub today</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Name row */}
            <div className="grid grid-cols-2 gap-3">
              <Field id="reg-firstname" label="First Name" name="firstName" placeholder="John" />
              <Field id="reg-lastname" label="Last Name" name="lastName" placeholder="Doe" />
            </div>

            <Field id="reg-email" label="Email" name="email" type="email" placeholder="john@example.com" />
            <Field id="reg-username" label="Username" name="username" placeholder="johndoe99" />
